...
var LeftTitleBox = React.createClass({displayName: "LeftTitleBox",
  ...
  render: function() {
    return (
      React.createElement("div", {value: "characterBaseStats", className: "left_title_box", onClick: this.handleClick}, 
        React.createElement("div", {value: "characterBaseStats", className: "value", onClick: this.handleClick}, this.props.character.name), 
        React.createElement("div", {value: "characterBaseStats", className: "label", onClick: this.handleClick}, "Name")
      )
    );
  }
});
...
var baseStatForm = React.createClass({displayName: "baseStatForm",
