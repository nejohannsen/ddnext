  ...
  render: function() {
    return (
      React.createElement("div", {className: "sub_race"}, 
        React.createElement("label", {htmlFor: this.props.title.replace(/ /g,"_")}, this.props.title), 
        React.createElement("input", {id: this.props.title.replace(/ /g,"_"), type: "radio", value: this.props.title, name: "sub_race_option"})
      )
    );
  }
});
