  ...
  render: function() {
    return (
      React.createElement("div", {value: "characterBaseStats", className: "left_title_box", onClick: this.handleClick}, 
        React.createElement("div", {value: "characterBaseStats", className: "value"}, this.props.character.name), 
        React.createElement("div", {value: "characterBaseStats", className: "label"}, "Name")
      )
    );
  }
});
