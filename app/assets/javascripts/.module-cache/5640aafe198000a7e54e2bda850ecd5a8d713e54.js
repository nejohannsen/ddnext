...
var ClassOptions = React.createClass({displayName: "ClassOptions",
  onSubmit: function(e) {
    e.preventDefault();
    debugger
    /* this.props.handleSubmit(something) */
  },
  render: function() {
    return (
      React.createElement("form", {id: "addClassForm", onSubmit: this.onSubmit}, 
...
var AddClassesForm = React.createClass({displayName: "AddClassesForm",
  ...
  render: function() {
    ...
    var optionNodes = this.props.avaliable_classes.map(function (gclass) {
      return (
        React.createElement(ClassOptions, {id: gclass.id, title: gclass.title, handelSubmit: this.handleSubmit})
      );
    });
