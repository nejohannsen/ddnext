  ...
  render: function() {
    return (
      React.createElement("div", {className: "right_title_box"}, 
        ...
        React.createElement("div", {value: "base_stats", onClick: this.handlePopupForm, className: "field"}, 
          React.createElement("div", {value: "base_stats", className: "value"}, this.props.character.player_name), 
    ...
    return (
      React.createElement("div", {id: "character_base_stats", className: "popup_form"}, 
        ...
        React.createElement("form", null, 
          ...
          React.createElement("label", {name: "player_name"}, "Player Name"), 
          React.createElement("input", {name: "player_name", type: "text", value: this.props.character.player_name, onChange: this.handelChange})
        )
      )
    );
  }
