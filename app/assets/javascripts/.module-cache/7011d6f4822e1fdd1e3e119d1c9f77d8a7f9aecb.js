...
var SubRaceList = React.createClass({displayName: "SubRaceList",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "sub_race", onClick: this.handelClick}, 
        React.createElement("input", {id: this.props.title.replace(/ /g,"_").toLowerCase(), type: "radio", value: this.props.title, name: "sub_race_option"}), 
