  ...
  render: function() {
    return (
      React.createElement("div", {id: "FullPage"}, 
        React.createElement(MainTitle, {addClassToCharacter: this.addClassToCharacter, character: this.state.data.character}), 
        React.createElement(MainPage, null), 
        React.createElement(AddClassesForm, {data: this.state.data})
      )
    );
  }
});
...
var AddClassesForm = React.createClass({displayName: "AddClassesForm",
  handleSubmit: function(e) {
    e.preventDefault();
    var selectValue = this.refs.text.getDOMNode().value
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "popup_form"}, 
        React.createElement("form", {id: "addClassForm"}, 
...
$( document ).ready(function() {
  var url = "localhost:3000/api/character/" + baked.character.id
  React.render(
