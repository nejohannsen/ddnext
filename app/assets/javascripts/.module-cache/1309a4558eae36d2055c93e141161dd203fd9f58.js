...
var ClassAndLevelList = React.crateClass({
  redner: function() {
    return (
      React.createElement("li", null, "Took a level in ", this.props.title, " at character level")
    );
  }
});
...
var AddClassesForm = React.createClass({displayName: "AddClassesForm",
  ...
  render: function() {
    ...
    var characterClassNodes = this.props.data.character_classes.map(function (cclass) {
      return (
        React.createElement(ClassOptions, {id: cclass.id, class_id: cclass.game_class_id, title: cclass.gclass_title, level: cclass.character_level})
      );
    });
